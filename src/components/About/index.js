...
const CardTotals = () => (
  <CardResponsive>
    ...
    <CardTitle
      title="Servicii sociale licențiate"
      subtitle="România, Decembrie 2016"
    />
    <CardText>
      <superscript>*</superscript>
      {' '}
      în perioada următoare vom completa harta cu toate înregistrările
    </CardText>
  </CardResponsive>
);
const CardProviders = () => (
  <CardResponsive>
    ...
    <CardTitle
      title="Furnizori acreditați"
      subtitle="Ianuarie - Decembrie 2016"
    />
    <CardText>
...
const CardRatio = () => (
  <CardResponsive>
    ...
    <CardTitle
      title="Raportul serviciilor sociale licențiate"
      subtitle="Servicii publice / Servicii private"
    />
    <CardText>
      <PieChartRatio />
...
const CardHomeless = () => (
  <CardResponsive>
    ...
    <CardTitle
      ...
      subtitle="Total centre / Locuri capacitate"
    />
    <CardText>
      <ChartHomeless />
      <superscript>*</superscript>
      {' '}
      cate 2 centre în Alba, Bacău, Caraș Severin și Harghita
      {' '}
      <br />
      1 centru în Arad, Bihor, Brașov, București, Covasna, Dolj, Dâmbovița, Galați, Hunedoara, Iași, Mureș, Sibiu si Teleorman
    </CardText>
  </CardResponsive>
);
const CardChildren = () => (
  <CardResponsive>
    ...
    <CardText>
      ...
      <superscript>*</superscript>
      {' '}
      în 41 de județe exista cel puțin un centru care oferă servicii pentru copii
    </CardText>
  </CardResponsive>
);
