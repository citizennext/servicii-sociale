  ...
  return (
    <Container>
      ...
      <div style={{minHeight: '100%', marginTop: '54px', maxWidth: '100vw'}}>
        ...
        <p>Utilizatorii pot contribui la acuratețea datelor prezentate pe <a href="http://harta-furnizori.mmuncii.ro">harta-furnizori.mmuncii.ro</a> și pot trimite observații și propuneri de îmbunătățire a platformei la adresa de email <a href="mailto:acreditare@mmuncii.gov.ro">acreditare@mmuncii.gov.ro</a>.</p>
